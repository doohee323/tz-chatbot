"""Sync: fetch Dify conversation list and messages and store in DB (SQLite or PostgreSQL)."""
import logging
import uuid
...
async def record_chat_to_db(
    ...
    """Record one chat to DB right after Dify response. (No separate sync needed)."""
    now = datetime.utcnow()
